...
total_size = 0
top_level_size = above_top_level_dir.contents[0].get_size()
# print(top_level_size)
remaining_space = 70000000 - top_level_size
# print(remaining_space)
required_space = 30000000 - remaining_space
# print(required_space)

flattened_contents = above_top_level_dir.contents[0].get_flattened_contents()
dir_to_delete_size = top_level_size
for c in flattened_contents:
    if isinstance(c, Directory):
        size = c.get_size()
        if required_space <= size < dir_to_delete_size:
